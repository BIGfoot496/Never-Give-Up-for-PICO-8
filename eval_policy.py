...
def rollout(policy, env, ep, render):
    """
...
def eval_policy(policy, env, ep, render=False):
    """
    ...
    for ep_num, (ep_len, ep_ret) in enumerate(rollout(policy, env, ep, render)):
